...
block in a direction and you know it takes you one minute to traverse one city block, so create a function that 
will return true if the walk the app gives you will take you exactly ten minutes (you don't want to be early or 
...
def is_valid_walk(walk):
    ...
    if len(walk) == 10 and countE == countW and countN == countS:
        print (True)
    else:
        print (False)
  
walk = ['n','s','n','s','n','s','n','s','s','n']
is_valid_walk(walk)
